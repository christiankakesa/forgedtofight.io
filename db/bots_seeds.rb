...
[
  ...
  {
    name: 'Scorponok',
    description: 'Scorponok’s seemingly slow wit contrasts sharply with his cunning and inventive nature. Fiercely loyal to his commander Megatron, Scorponok is one of the few Predacon subordinates that harbors no desire to usurp the lizard king.',
    icon_url: '/images/bots/scorponok.jpeg',
